...
'use strict'; (function (P, Q)
{ "object" === typeof exports && "undefined" !== typeof module ? module.exports = Q() : "function" === typeof define && define.amd ? define(Q) : (P = P || self, P.Shepherd = Q()) })(this, function () {
    function P(a, b) { for (var c = 0; c < b.length; c++){ var d = b[c]; d.enumerable = d.enumerable || !1; d.configurable = !0; "value" in d && (d.writable = !0); Object.defineProperty(a, d.key, d) } } function Q(a, b, c) { b && P(a.prototype, b); c && P(a, c); return a } function ra() {
        ra = Object.assign || function (a) {
            for (var b = 1; b < arguments.length; b++){
                var c = arguments[b], d; for (d in c) Object.prototype.hasOwnProperty.call(c, d) && (a[d] = c[d])
            } return a
        }; return ra.apply(this, arguments)
    } function C(a, b) { a.prototype = Object.create(b.prototype); a.prototype.constructor = a; a.__proto__ = b } function x(a) { if (void 0 === a) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return a } function R(a) { return "function" === typeof a } function Z(a) { return "string" === typeof a } function Da(a) {
        for (var b = Object.getOwnPropertyNames(a.constructor.prototype), c = 0; c < b.length; c++){ var d = b[c], e = a[d]; "constructor" !== d && "function" === typeof e && (a[d] = e.bind(a)) } return a
    } function lb(a, b) {
        return function (c) { if (b.isOpen()) { var d = b.el && c.currentTarget === b.el; (void 0 !== a && c.currentTarget.matches(a) || d) && b.tour.next() } }
    } function mb(a) {
        var b = a.options.advanceOn || {}, c = b.event; b = b.selector; if (c) {
            var d = lb(b, a); try { var e = document.querySelector(b) } catch (f) { } if (void 0 === b || e) e ? (e.addEventListener(c, d), a.on("destroy", function () { return e.removeEventListener(c, d) })) : (document.body.addEventListener(c,
                d, !0), a.on("destroy", function () {
                    return document.body.removeEventListener(c, d, !0)
                })); else return console.error("No element was found for the selector supplied to advanceOn: " + b)
        } else return console.error("advanceOn was defined, but no event name was passed.")
    } function aa(a) { a = a.getBoundingClientRect(); return { width: a.width, height: a.height, top: a.top, right: a.right, bottom: a.bottom, left: a.left, x: a.left, y: a.top } } function A(a) {
    ...
    } function D(a) { var b = A(a).HTMLElement; return a instanceof b || a instanceof HTMLElement } function F(a) { return a ? (a.nodeName || "").toLowerCase() : null } function M(a) { return (ba(a) ? a.ownerDocument : a.document).documentElement } function Ea(a) { return aa(M(a)).left + sa(a).scrollLeft } function Fa(a, b, c) {
        void 0 === c && (c = !1); a = aa(a); var d = { scrollLeft: 0, scrollTop: 0 },
            e = { x: 0, y: 0 };
        if (!c) if ("body" !== F(b) && (d = b !== A(b) && D(b) ? { scrollLeft: b.scrollLeft, scrollTop: b.scrollTop } : sa(b)), D(b)) e = aa(b), e.x += b.clientLeft, e.y += b.clientTop; else if (b = M(b)) e.x = Ea(b); return { x: a.left + d.scrollLeft - e.x, y: a.top + d.scrollTop - e.y, width: a.width, height: a.height }
    } function ta(a) { return { x: a.offsetLeft, y: a.offsetTop, width: a.offsetWidth, height: a.offsetHeight } } function Ga(a) { return "html" === F(a) ? a : a.parentNode || a.host || document.ownerDocument || document.documentElement } function ca(a) { return A(a).getComputedStyle(a) }
    function Ha(a) {
        if (0 <= ["html", "body", "#document"].indexOf(F(a))) return a.ownerDocument.body; if (D(a)) { var b = ca(a); if (/auto|scroll|overlay|hidden/.test(b.overflow + b.overflowY + b.overflowX)) return a } return Ha(Ga(a))
    } function ja(a, b) { void 0 === b && (b = []); var c = Ha(a); c = (a = "body" === F(c)) ? A(c) : c; b = b.concat(c); return a ? b : b.concat(ja(Ga(c))) } function Ia(a) { var b; return !D(a) || !(b = a.offsetParent) || "undefined" !== typeof window.InstallTrigger && "fixed" === ca(b).position ? null : b } function da(a) {
        var b = A(a); for (a = Ia(a); a &&
            0 <= ["table", "td", "th"].indexOf(F(a));)a = Ia(a);
        return a && "body" === F(a) && "static" === ca(a).position ? b : a || b
    } function nb(a) {
        function b(a) { d.add(a.name);[].concat(a.requires || [], a.requiresIfExists || []).forEach(function (a) { d.has(a) || (a = c.get(a)) && b(a) }); e.push(a) } var c = new Map, d = new Set, e = []; a.forEach(function (a) { c.set(a.name, a) }); a.forEach(function (a) { d.has(a.name) || b(a) }); return e
    } function ob(a) { var b = nb(a); return pb.reduce(function (a, d) { return a.concat(b.filter(function (a) { return a.phase === d })) }, []) }
    function qb(a) {
        var b;
        return function () { b || (b = new Promise(function (c) { Promise.resolve().then(function () { b = void 0; c(a()) }) })); return b }
    } function E(a) {
        return a.split("-")[0]
    } function rb(a) { var b = a.reduce(function (a, b) { var c = a[b.name]; a[b.name] = c ? Object.assign({}, c, {}, b, { options: Object.assign({}, c.options, {}, b.options), data: Object.assign({}, c.data, {}, b.data) }) : b; return a }, {}); return Object.keys(b).map(function (a) { return b[a] }) } function Ja() {
        ...
        var b = a.reference, c = a.element, d = (a = a.placement) ? E(a) : null; a = a ? a.split("-")[1] : null; var e = b.x + b.width / 2 - c.width / 2, f = b.y + b.height / 2 - c.height / 2; switch (d) { case "top": e = { x: e, y: b.y - c.height }; break; case "bottom": e = { x: e, y: b.y + b.height }; break; case "right": e = { x: b.x + b.width, y: f }; break; case "left": e = { x: b.x - c.width, y: f }; break; default: e = { x: b.x, y: b.y } }d =
            d ? ua(d) : null; if (null != d)
            switch (f = "y" === d ? "height" : "width", a) { case "start": e[d] = Math.floor(e[d]) - Math.floor(b[f] / 2 - c[f] / 2); break; case "end": e[d] = Math.floor(e[d]) + Math.ceil(b[f] / 2 - c[f] / 2) }return e
    } function La(a) {
        var b, c = a.popper, d = a.popperRect, e = a.placement, f = a.offsets, h = a.position, k = a.gpuAcceleration, l = a.adaptive, g = window.devicePixelRatio || 1; a = Math.round(f.x * g) / g || 0; g = Math.round(f.y * g) / g || 0; var m = f.hasOwnProperty("x"); f = f.hasOwnProperty("y"); var p = "left", t = "top", q = window; if (l) {
            var y = da(c); y === A(c) &&
(y=M(c));"top"===e&&(t="bottom",g-=y.clientHeight-d.height,g*=k?1:-1);"left"===e&&(p="right",a-=y.clientWidth-d.width,a*=k?1:-1)}c=Object.assign({position:h},l&&sb);if(k){var u;return Object.assign({},c,(u={},u[t]=f?"0":"",u[p]=m?"0":"",u.transform=2>(q.devicePixelRatio||1)?"translate("+a+"px, "+g+"px)":"translate3d("+a+"px, "+g+"px, 0)",u))}return Object.assign({},c,(b={},b[t]=f?g+"px":"",b[p]=m?a+"px":"",b.transform="",b))}function ka(a){return a.replace(/left|right|bottom|top/g,function(a){return tb[a]})}
    function Ma(a) {
        return a.replace(/start|end/g, function (a) { return ub[a] })
        ...
        if ("viewport" === b) a = A(a), a = va({ width: a.innerWidth, height: a.innerHeight, x: 0, y: 0 }); else if (D(b)) a = aa(b); else {
            var c = M(a); a = A(c); b = sa(c); c = Fa(M(c),
...
0;var g=parseFloat(k.borderBottomWidth)||0;var m=parseFloat(k.borderLeftWidth)||0;k="html"===F(c);var p=Ea(c),t=c.clientWidth+l,q=c.clientHeight+g;k&&50<e.innerHeight-c.clientHeight&&(q=e.innerHeight-g);g=k?0:c.clientTop;l=c.clientLeft>m?l:k?e.innerWidth-t-p:c.offsetWidth-t;e=k?e.innerHeight-q:c.offsetHeight-q;c=k?p:c.clientLeft;b.top=Math.max(d.top+g,b.top);b.right=Math.min(d.right-l,b.right);b.bottom=Math.min(d.bottom-e,b.bottom);b.left=Math.max(d.left+c,b.left);return b},Oa(a,c[0]));c.width=c.right-
            c.left; c.height = c.bottom - c.top; c.x = c.left; c.y = c.top;
        return c
    } function Pa(a) { return Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }, {}, a) } function Qa(a, b) { return b.reduce(function (b, d) { b[d] = a; return b }, {}) } function ea(a, b) {
        void 0 === b && (b = {}); var c = b; b = c.placement; b = void 0 === b ? a.placement : b; var d = c.boundary, e = void 0 === d ? "clippingParents" : d; d = c.rootBoundary; var f = void 0 === d ? "viewport" : d; d = c.elementContext; d = void 0 === d ? "popper" : d; var h = c.altBoundary, k = void 0 === h ? !1 : h; c = c.padding; c = void 0 === c ? 0 : c; c = Pa("number" !==
...
"bottom"].indexOf(a)?1:-1,c=0<=["top","bottom"].indexOf(a)?"y":"x";g[a]+=m[c]*b})}return g}function xb(a,b){void 0===b&&(b={});var c=b.boundary,d=b.rootBoundary,e=b.padding,f=b.flipVariations,h=b.placement.split("-")[1],k=(h?f?Ra:Ra.filter(function(a){return a.split("-")[1]===h}):fa).reduce(function(b,f){b[f]=ea(a,{placement:f,boundary:c,rootBoundary:d,padding:e})[E(f)];return b},{});return Object.keys(k).sort(function(a,b){return k[a]-k[b]})}function yb(a){if("auto"===E(a))return[];var b=ka(a);return[Ma(a),
        ...
        void 0 === c && (c = { x: 0, y: 0 });
        return { top: a.top - b.height - c.y, right: a.right - b.width + c.x, bottom: a.bottom - b.height + c.y, left: a.left - b.width - c.x }
    } function Ta(a) {
        ...
        return [{
            name: "applyStyles", fn: function (a) {
                var b = a.state; Object.keys(b.elements).forEach(function (a) {
                    if ("popper" === a) {
                        var c = b.attributes[a] || {}, e = b.elements[a]; Object.assign(e.style, { position: "fixed", left: "50%", top: "50%", transform: "translate(-50%, -50%)" });
Object.keys(c).forEach(function(a){var b=c[a];!1===b?e.removeAttribute(a):e.setAttribute(a,!0===b?"":b)})}})}},{name:"computeStyles",options:{adaptive:!1}}]}function Ab(a){var b=zb(),c=a.shepherdElementComponent.getElement();a=Bb(a);c.classList.add("shepherd-centered");return a=ra({},a,{modifiers:Array.from(new Set([].concat(a.modifiers,b)))})}function Bb(a){return{placement:"top",strategy:"fixed",modifiers:[],onFirstUpdate:function(){a.el.focus()}}}function Ua(a){return Z(a)&&""!==a?"-"!==a.charAt(a.length-
    1) ? a + "-" : a : ""
        ...
        a = a.options.attachTo || {}; var b = Object.assign({}, a);
        if (Z(a.element)) { try { b.element = document.querySelector(a.element) } catch (c) { } b.element || console.error("The element for this Shepherd step was not found " + a.element) } return b
    } function wa() {
        var a = Date.now();
        return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (b) { var c = (a + 16 * Math.random()) % 16 | 0; a = Math.floor(a / 16); return ("x" == b ? c : c & 3 | 8).toString(16) })
    } function Cb(a, b) {
        var c = {
            modifiers: [{
...
options:{altAxis:!0}}],strategy:"absolute",onFirstUpdate:function(){b.el.focus()}},d=document.body;a.element&&a.on?(c.placement=a.on||"right",d=a.element):c=Ab(b);if(b.options.popperOptions){if(b.options.popperOptions.modifiers&&0<b.options.popperOptions.modifiers.length){var e=b.options.popperOptions.modifiers.map(function(a){return a.name});a=c.modifiers.filter(function(a){return!e.includes(a.name)});c.modifiers=Array.from(new Set([].concat(a,b.options.popperOptions.modifiers)))}c=Object.assign(b.options.popperOptions,
    ...
    } function z() { } function Db(a, b) { for (var c in b) a[c] = b[c]; return a } function S(a) { return a() } function Wa(a) { return "function" === typeof a } function G(a, b) { return a != a ? b == b : a !== b || a && "object" === typeof a || "function" === typeof a } function B(a) { a.parentNode.removeChild(a) } function Xa(a) { return document.createElementNS("http://www.w3.org/2000/svg", a) } function la(a, b, c, d) { a.addEventListener(b, c, d); return function () { return a.removeEventListener(b, c, d) } } function r(a,
...
{},g=a.$$={fragment:null,ctx:null,props:f,update:z,not_equal:e,bound:Object.create(null),on_mount:[],on_destroy:[],before_update:[],after_update:[],context:new Map(k?k.$$.context:[]),callbacks:Object.create(null),dirty:h},m=!1;g.ctx=c?c(a,l,function(b,c){var d=(2>=arguments.length?0:arguments.length-2)?2>=arguments.length?void 0:arguments[2]:c;if(g.ctx&&e(g.ctx[b],g.ctx[b]=d)){if(g.bound[b])g.bound[b](d);m&&(-1===a.$$.dirty[0]&&(ha.push(a),Aa||(Aa=!0,Eb.then(Za)),a.$$.dirty.fill(0)),a.$$.dirty[b/
    ...
    return c
}) : []; g.update(); m = !0; g.before_update.forEach(S); g.fragment = d ? d(g.ctx) : !1; b.target && (b.hydrate ? (c = Array.from(b.target.childNodes), g.fragment && g.fragment.l(c), c.forEach(B)) : g.fragment && g.fragment.c(), b.intro && n(a.$$.fragment), J(a, b.target, b.anchor), Za()); U = k
    } function Fb(a) {
        var b, c, d, e, f;
        return {
            c: function () {
                b = document.createElement("button"); c = document.createTextNode(a[3]); r(b, "aria-label", d = a[4] ? a[4] : null); r(b, "class", e = (a[1] || "") + " shepherd-button " + (a[2] ? "shepherd-button-secondary" :
...
h,k,l,g,m;a.$set=function(a){"config"in a&&c(6,d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=function(){if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,h=d.classes);c(2,k=d.secondary);c(3,l=d.text);c(4,g=d.label);if(d.disabled){var b=d.disabled;b=R(b)?b.call(e):b}else b=!1;c(5,m=b)}};return[f,h,k,l,g,m,d,e]}function ab(a,b,c){a=a.slice();a[2]=b[c];return a}function bb(a){for(var b,c,d=a[1],e=[],f=0;f<d.length;f+=1)e[f]=cb(ab(a,d,f));var h=function(a){return v(e[a],1,1,function(){e[a]=
    ...
    return {
        c: function () {
            for (var a = 0; a < e.length; a += 1)e[a].c(); b = document.createTextNode("")
        }, m: function (a, d) {
            for (var f = 0; f < e.length; f += 1)e[f].m(a, d); a.insertBefore(b, d || null); c = !0
        }, p: function (a, c) {
            if (c & 3) {
                d = a[1]; var f;
                for (f = 0; f < d.length; f += 1){ var k = ab(a, d, f); e[f] ? (e[f].p(k, c), n(e[f], 1)) : (e[f] = cb(k), e[f].c(), n(e[f], 1), e[f].m(b.parentNode, b)) } W(); for (f = d.length; f < e.length; f += 1)h(f); X()
            }
        }, i: function (a) {
            if (!c) {
                for (a = 0; a < d.length; a += 1)n(e[a]); c = !0
            }
        }, o: function (a) {
            e = e.filter(Boolean);
            for (a = 0; a < e.length; a +=
                ...
                for (var c = e, d = 0; d < c.length; d += 1)c[d] && c[d].d(a); a && B(b)
            }
        }
    } function cb(a) { var b, c = new Hb({ props: { config: a[2], step: a[0] } }); return { c: function () { O(c.$$.fragment) }, m: function (a, e) { J(c, a, e); b = !0 }, p: function (a, b) { var d = {}; b & 2 && (d.config = a[2]); b & 1 && (d.step = a[0]); c.$set(d) }, i: function (a) { b || (n(c.$$.fragment, a), b = !0) }, o: function (a) { v(c.$$.fragment, a); b = !1 }, d: function (a) { K(c, a) } } } function Ib(a) {
        var b, c, d = a[1] && bb(a);
        return {
            c: function () {
                b = document.createElement("footer"); d && d.c();
...
document.createElement("button");c=document.createElement("span");c.textContent="\u00d7";r(c,"aria-hidden","true");r(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");r(b,"class","shepherd-cancel-icon");r(b,"type","button")},m:function(d,h,k){d.insertBefore(b,h||null);b.appendChild(c);k&&e();e=la(b,"click",a[1])},p:function(a,c){c[0]&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&r(b,"aria-label",d)},i:z,o:z,d:function(a){a&&B(b);e()}}}function Lb(a,b,c){var d=b.cancelIcon,e=b.step;a.$set=function(a){"cancelIcon"in
        a && c(0, d = a.cancelIcon); "step" in a && c(2, e = a.step)
    };
        return [d, function (a) { a.preventDefault(); e.cancel() }, e]
    } function Mb(a) {
        var b;
        return { c: function () { b = document.createElement("h3"); r(b, "id", a[1]); r(b, "class", "shepherd-title") }, m: function (c, d) { c.insertBefore(b, d || null); a[3](b) }, p: function (a, d) { d[0] & 2 && r(b, "id", a[1]) }, i: z, o: z, d: function (c) { c && B(b); a[3](null) } }
    } function Nb(a, b, c) {
        var d = b.labelId, e = b.element, f = b.title; ma().$$.after_update.push(function () { R(f) && c(2, f = f()); c(0, e.innerHTML = f, e) }); a.$set = function (a) {
            "labelId" in
a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){V[a?"unshift":"push"](function(){c(0,e=a)})}]}function db(a){var b,c=new Ob({props:{labelId:a[0],title:a[2]}});return{c:function(){O(c.$$.fragment)},m:function(a,e){J(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.labelId=a[0]);b&4&&(d.title=a[2]);c.$set(d)},i:function(a){b||(n(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){K(c,a)}}}function eb(a){var b,c=new Pb({props:{cancelIcon:a[3],
    step: a[1]
        ...
        return { c: function () { O(c.$$.fragment) }, m: function (a, e) { J(c, a, e); b = !0 }, p: function (a, b) { var d = {}; b & 8 && (d.cancelIcon = a[3]); b & 2 && (d.step = a[1]); c.$set(d) }, i: function (a) { b || (n(c.$$.fragment, a), b = !0) }, o: function (a) { v(c.$$.fragment, a); b = !1 }, d: function (a) { K(c, a) } }
    } function Qb(a) {
        var b, c, d, e = a[2] && db(a), f = a[3] && a[3].enabled && eb(a); return {
            c: function () { b = document.createElement("header"); e && e.c(); c = document.createTextNode(" "); f && f.c(); r(b, "class", "shepherd-header") }, m: function (a, k) {
                a.insertBefore(b,
...
(n(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){K(c,a)}}}function gb(a){var b,c=new Vb({props:{step:a[2]}});return{c:function(){O(c.$$.fragment)},m:function(a,e){J(c,a,e);b=!0},p:function(a,b){var d={};b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(n(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){K(c,a)}}}function Wb(a){var b,c,d=void 0!==a[2].options.text,e,f=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,h,k=new Xb({props:{labelId:a[1],
    ...
    return {
        c: function () { b = document.createElement("div"); O(k.$$.fragment); c = document.createTextNode(" "); l && l.c(); e = document.createTextNode(" "); g && g.c(); r(b, "class", "shepherd-content") }, m: function (a, d) { a.insertBefore(b, d || null); J(k, b, null); b.appendChild(c); l && l.m(b, null); b.appendChild(e); g && g.m(b, null); h = !0 }, p: function (a, c) {
            c = c[0]; var h = {}; c & 2 && (h.labelId = a[1]); c & 4 && (h.step = a[2]); k.$set(h); c & 4 && (d = void 0 !== a[2].options.text); d ? l ? (l.p(a, c), n(l, 1)) : (l = fb(a), l.c(), n(l,
1),l.m(b,e)):l&&(W(),v(l,1,1,function(){l=null}),X());c&4&&(f=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);f?g?(g.p(a,c),n(g,1)):(g=gb(a),g.c(),n(g,1),g.m(b,null)):g&&(W(),v(g,1,1,function(){g=null}),X())},i:function(a){h||(n(k.$$.fragment,a),n(l),n(g),h=!0)},o:function(a){v(k.$$.fragment,a);v(l);v(g);h=!1},d:function(a){a&&B(b);K(k);l&&l.d();g&&g.d()}}}function Yb(a,b,c){var d=b.descriptionId,e=b.labelId,f=b.step;a.$set=function(a){"descriptionId"in a&&c(0,d=a.descriptionId);
        "labelId" in a && c(1, e = a.labelId); "step" in a && c(2, f = a.step)
    };
        return [d, e, f]
    } function hb(a) {
        var b;
        return { c: function () { b = document.createElement("div"); r(b, "class", "shepherd-arrow"); r(b, "data-popper-arrow", "") }, m: function (a, d) { a.insertBefore(b, d || null) }, d: function (a) { a && B(b) } }
    } function Zb(a) {
        for (var b, c, d, e, f = a[4].options.arrow && a[4].options.attachTo && a[4].options.attachTo.element && hb(), h = new $b({ props: { descriptionId: a[2], labelId: a[3], step: a[4] } }), k = [{
            "aria-describedby": void 0 !== a[4].options.text ? a[2] :
...
a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element?f||(f=hb(),f.c(),f.m(b,c)):f&&(f.d(1),f=null);d={};e&4&&(d.descriptionId=a[2]);e&8&&(d.labelId=a[3]);e&16&&(d.step=a[4]);h.$set(d);d=b;e=[e&20&&{"aria-describedby":void 0!==a[4].options.text?a[2]:null},e&24&&{"aria-labelledby":a[4].options.title?a[3]:null},e&2&&a[1],{role:"dialog"},{tabindex:"0"}];for(var g={},l={},u={$$scope:1},w=k.length;w--;){var m=k[w],ia=e[w];if(ia){for(var p in m)p in ia||(l[p]=1);for(var pa in ia)u[pa]||
                (g[pa] = ia[pa], u[pa] = 1); k[w] = ia
            }
            else for (var r in m) u[r] = 1
            } for (var n in l) n in g || (g[n] = void 0); Ya(d, g); T(b, "shepherd-has-cancel-icon", a[5]); T(b, "shepherd-has-title", a[6]); T(b, "shepherd-element", !0)
        }, i: function (a) { d || (n(h.$$.fragment, a), d = !0) }, o: function (a) { v(h.$$.fragment, a); d = !1 }, d: function (c) { c && B(b); f && f.d(); K(h); a[17](null); e() }
        }
    } function ib(a) { return a.split(" ").filter(function (a) { return !!a.length }) } function bc(a, b, c) {
        function d() { e(L); L = q.options.classes; f(L) } function e(a) {
            if (Z(a) && (a = ib(a),
                a.length)) { var b; (b = k.classList).remove.apply(b, a) }
        } function f(a) {
            if (Z(a) && (a = ib(a), a.length)) { var b; (b = k.classList).add.apply(b, a) }
        } var h = b.classPrefix, k = b.element, l = b.descriptionId, g = b.firstFocusableElement, m = b.focusableElements, p = b.labelId, t = b.lastFocusableElement, q = b.step, y = b.dataStepId, u, w, L; ma().$$.on_mount.push(function () {
            var a; c(1, y = (a = {}, a["data-" + h + "shepherd-step-id"] = q.id, a)); c(9, m = k.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));
...
a.$$.update=function(){a.$$.dirty&16&&(c(5,u=q.options&&q.options.cancelIcon&&q.options.cancelIcon.enabled),c(6,w=q.options&&q.options.title))};return[k,y,l,p,q,u,w,function(a){var b=q.tour;switch(a.keyCode){case 9:if(0===m.length){a.preventDefault();break}a.shiftKey?document.activeElement===g&&(a.preventDefault(),t.focus()):document.activeElement===t&&(a.preventDefault(),g.focus());break;case 27:b.options.exitOnEsc&&q.cancel();break;case 37:b.options.keyboardNavigation&&b.back();break;case 39:b.options.keyboardNavigation&&
            ...
            return k
        }, L, d, e, f, function (a) { V[a ? "unshift" : "push"](function () { c(0, k = a) }) }]
    } function cc(a) { a && a.steps.forEach(function (a) { a.options && !1 === a.options.canClickTarget && a.options.attachTo && a.target instanceof HTMLElement && a.target.classList.remove("shepherd-target-click-disabled") }) } function dc(a) {
        var b, c, d, e;
        return {
            c: function () { b = Xa("svg"); c = Xa("path"); r(c, "d", a[2]); r(b, "class", d = (a[1] ? "shepherd-modal-is-visible" : "") + " shepherd-modal-overlay-container") }, m: function (d, h, k) {
                d.insertBefore(b,
h||null);b.appendChild(c);a[17
](b);k&&e();e=la(b,"touchmove",a[3])},p:function(a,e){e=e[0];e&4&&r(c,"d",a[2]);e&2&&d!==(d=(a[1]?"shepherd-modal-is-visible":"")+" shepherd-modal-overlay-container")&&r(b,"class",d)},i:z,o:z,d:function(c){c&&B(b);a[17](null);e()}}}function jb(a){if(!a)return null;var b=a instanceof HTMLElement&&window.getComputedStyle(a).overflowY;return"hidden"!==b&&"visible"!==b&&a.scrollHeight>=a.clientHeight?a:jb(a.parentElement)}function ec(a,b,c){function d(){c(4,p={width:0,height:0,
    x: 0, y: 0, r: 0
})
} function e() { c(1, t = !1); l() } function f(a, b, d, e) {
    void 0 === d && (d = 0); void 0 === e && (e = 0);
    if (a.getBoundingClientRect) { var f = a.getBoundingClientRect(); var g = f.y || f.top; f = f.bottom || g + f.height; if (b) { var u = b.getBoundingClientRect(); b = u.y || u.top; u = u.bottom || b + u.height; g = Math.max(g, b); f = Math.min(f, u) } b = g; g = Math.max(f - g, 0); a = a.getBoundingClientRect(); f = a.left; c(4, p = { width: a.width + 2 * d, height: g + 2 * d, x: (a.x || f) - d, y: b - d, r: e }) }
} function h() { c(1, t = !0) } function k() { window.addEventListener("touchmove", u, { passive: !1 }) }
function l(){q&&(cancelAnimationFrame(q),q=void 0);window.removeEventListener("touchmove",u,{passive:!1})}function g(a){var b=a.options,c=b.modalOverlayOpeningPadding,e=b.modalOverlayOpeningRadius;if(a.target){var g=jb(a.target);(function ac(){q=void 0;f(a.target,g,c,e);q=requestAnimationFrame(ac)})();k()}else d()}var m=b.element,p=b.openingProperties;b=wa();var t=!1,q=void 0,y;d();var u=function(a){a.preventDefault()};a.$set=function(a){"element"in a&&c(0,m=a.element);"openingProperties"in a&&c(4,
    p = a.openingProperties)
    }; a.$$.update = function () {
        if (a.$$.dirty & 16) { var b = p.x; b = void 0 === b ? 0 : b; var d = p.y; d = void 0 === d ? 0 : d; var e = p.r; e = void 0 === e ? 0 : e; var f = window, g = f.innerWidth; f = f.innerHeight; c(2, y = "M" + g + "," + f + "H0V0H" + g + "V" + f + "ZM" + (b + e) + "," + d + "a" + e + "," + e + ",0,0,0-" + e + "," + e + "V" + (p.height + d - e) + "a" + e + "," + e + ",0,0,0," + e + "," + e + "H" + (p.width + b - e) + "a" + e + "," + e + ",0,0,0," + e + "-" + e + "V" + (d + e) + "a" + e + "," + e + ",0,0,0-" + e + "-" + e + "Z") }
    }; return [m, t, y, function (a) { a.stopPropagation() }, p, function () { return m }, d, e, f, function (a) {
        l();
a.tour.options.useModalOverlay?(g(a),h()):e()},h,q,b,u,k,l,g,function(a){V[a?"unshift":"push"](function(){c(0,m=a)})}]}var Ba=function(){function a(){}var b=a.prototype;b.on=function(a,b,e,f){void 0===f&&(f=!1);void 0===this.bindings&&(this.bindings={});void 0===this.bindings[a]&&(this.bindings[a]=[]);this.bindings[a].push({handler:b,ctx:e,once:f});return this};b.once=function(a,b,e){return this.on(a,b,e,!0)};b.off=function(a,b){var c=this;if(void 0===this.bindings||void 0===this.bindings[a])return this;
    void 0 === b ? delete this.bindings[a] : this.bindings[a].forEach(function (d, e) { d.handler === b && c.bindings[a].splice(e, 1) });
    return this
...
g.options=Object.assign({},d,{},g.options,{},h);g.scrollParents={reference:ba(a)?ja(a):[],popper:ja(b)};h=ob(rb([].concat(c,g.options.modifiers)));g.orderedModifiers=h.filter(function(a){return a.enabled});e();return t.update()},forceUpdate:function(){if(!p){var a=g.elements,b=a.reference;a=a.popper;if(Ja(b,a))for(g.rects={reference:Fa(b,da(a),"fixed"===g.options.strategy),popper:ta(a)},g.reset=!1,g.placement=g.options.placement,g.orderedModifiers.forEach(function(a){return g.modifiersData[a.name]=
    Object.assign({}, a.data)
                ...
                if (!0 === g.reset) g.reset = !1, b = -1; else { var c = g.orderedModifiers[b]; a = c.fn; var d = c.options; d = void 0 === d ? {} : d; c = c.name; "function" === typeof a && (g = a({ state: g, options: d, name: c, instance: t }) || g) }
            }
            }, update: qb(function () {
                return new Promise(function (a) { t.forceUpdate(); a(g) })
            }), destroy: function () { f(); p = !0 }
        }; if (!Ja(a, b)) return t; t.setOptions(h).then(function (a) { if (!p && h.onFirstUpdate) h.onFirstUpdate(a) });
        return t
    }
}({
    defaultModifiers: [{
...
b.styles[a]||{},e=b.attributes[a]||{},f=b.elements[a];D(f)&&F(f)&&(Object.assign(f.style,c),Object.keys(e).forEach(function(a){var b=e[a];!1===b?f.removeAttribute(a):f.setAttribute(a,!0===b?"":b)}))})},effect:function(a){var b=a.state,c={popper:{position:"absolute",left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};Object.assign(b.elements.popper.style,c.popper);b.elements.arrow&&Object.assign(b.elements.arrow.style,c.arrow);return function(){Object.keys(b.elements).forEach(function(a){var d=
    b.elements[a], f = b.attributes[a] || {}; a = Object.keys(b.styles.hasOwnProperty(a) ? b.styles[a] : c[a]).reduce(function (a, b) {
        a[b] = "";
        return a
    }, {}); D(d) && F(d) && (Object.assign(d.style, a), Object.keys(f).forEach(function (a) { d.removeAttribute(a) }))
})
            }
            }, requires: ["computeStyles"]
        }, {
            name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: function (a) {
                var b = a.state, c = a.name; a = a.options.offset; var d = void 0 === a ? [0, 0] : a; a = fc.reduce(function (a, c) {
                    var e = b.rects; var f = E(c); var h = 0 <= ["left", "top"].indexOf(f) ?
-1:1,k="function"===typeof d?d(Object.assign({},e,{placement:c})):d;e=k[0];k=k[1];e=e||0;k=(k||0)*h;f=0<=["left","right"].indexOf(f)?{x:k,y:e}:{x:e,y:k};a[c]=f;return a},{});var e=a[b.placement],f=e.y;b.modifiersData.popperOffsets.x+=e.x;b.modifiersData.popperOffsets.y+=f;b.modifiersData[c]=a}},{name:"flip",enabled:!0,phase:"main",fn:function(a){var b=a.state,c=a.options;a=a.name;if(!b.modifiersData[a]._skip){var d=c.fallbackPlacements,e=c.padding,f=c.boundary,h=c.rootBoundary,k=c.altBoundary;c=c.flipVariations;
    var l = void 0 === c ? !0 : c; c = b.options.placement; var g = E(c); d = d || (g !== c && l ? yb(c) : [ka(c)]); var m = [c].concat(d).reduce(function (a, c) {
        return a.concat("auto" === E(c) ? xb(b, { placement: c, boundary: f, rootBoundary: h, padding: e, flipVariations: l }) : c)
    }, []); d = b.rects.reference; c = b.rects.popper; var p = new Map; g = !0; for (var t = m[0], q = 0; q < m.length; q++){
        var y = m[q], u = E(y), w = "start" === y.split("-")[1], L = 0 <= ["top", "bottom"].indexOf(u), n = L ? "width" : "height", r = ea(b, { placement: y, boundary: f, rootBoundary: h, altBoundary: k, padding: e }); w =
                    L ? w ? "right" : "left" : w ? "bottom" : "top"; d[n] > c[n] && (w = ka(w)); n = ka(w); u = [0 >= r[u], 0 >= r[w], 0 >= r[n]]; if (u.every(function (a) {
                        return a
                    })) { t = y; g = !1; break } p.set(y, u)
            } if (g) for (k = function (a) { var b = m.find(function (b) { if (b = p.get(b)) return b.slice(0, a).every(function (a) { return a }) }); if (b) return t = b, "break" }, d = l ? 3 : 1; 0 < d && "break" !== k(d); d--); b.placement !== t && (b.modifiersData[a]._skip = !0, b.placement = t, b.reset = !0)
        }
...
a.state,c=a.options;a=a.name;var d=c.mainAxis,e=void 0===d?!0:d;d=c.altAxis;d=void 0===d?!1:d;var f=c.tether;f=void 0===f?!0:f;var h=c.tetherOffset,k=void 0===h?0:h;c=ea(b,{boundary:c.boundary,rootBoundary:c.rootBoundary,padding:c.padding,altBoundary:c.altBoundary});h=E(b.placement);var l=b.placement.split("-")[1],g=!l,m=ua(h);h="x"===m?"y":"x";var p=b.modifiersData.popperOffsets,t=b.rects.reference,q=b.rects.popper,n="function"===typeof k?k(Object.assign({},b.rects,{placement:b.placement})):k;k=
                    { x: 0, y: 0 };
                if (e) {
                    var u = "y" === m ? "top" : "left", w = "y" === m ? "bottom" : "right", r = "y" === m ? "height" : "width"; e = p[m]; var v = p[m] + c[u], x = p[m] - c[w], A = f ? -q[r] / 2 : 0, z = "start" === l ? t[r] : q[r]; l = "start" === l ? -q[r] : -t[r]; q = b.elements.arrow; q = f && q ? ta(q) : { width: 0, height: 0 }; var B = b.modifiersData["arrow#persistent"] ? b.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 }; u = B[u]; w = B[w]; q = Math.max(0, Math.min(t[r], q[r])); z = g ? t[r] / 2 - A - q - u - n : z - q - u - n; g = g ? -t[r] / 2 + A + q + w + n : l + q + w + n; n = b.elements.arrow && da(b.elements.arrow);
t=b.modifiersData.offset?b.modifiersData.offset[b.placement][m]:0;n=p[m]+z-t-(n?"y"===m?n.clientTop||0:n.clientLeft||0:0);g=p[m]+g-t;f=Math.max(f?Math.min(v,n):v,Math.min(e,f?Math.max(x,g):x));p[m]=f;k[m]=f-e}d&&(d=p[h],f=Math.max(d+c["x"===m?"top":"left"],Math.min(d,d-c["x"===m?"bottom":"right"])),b.modifiersData.popperOffsets[h]=f,k[h]=f-d);b.modifiersData[a]=k},requiresIfExists:["offset"]},{name:"arrow",enabled:!0,phase:"main",fn:function(a){var b,c=a.state;a=a.name;var d=c.elements.arrow,e=c.modifiersData.popperOffsets,
    f = E(c.placement), h = ua(f); f = 0 <= ["left", "right"].indexOf(f) ? "height" : "width";
    if (d) { var k = c.modifiersData[a + "#persistent"].padding; d = ta(d); var l = "y" === h ? "top" : "left", g = "y" === h ? "bottom" : "right", m = c.rects.reference[f] + c.rects.reference[h] - e[h] - c.rects.popper[f]; e = e[h] - c.rects.reference[h]; var p = c.elements.arrow && da(c.elements.arrow); f = Math.max(k[l], Math.min(c.rects.popper[f] / 2 - d[f] / 2 + (m / 2 - e / 2 - (p ? "y" === h ? p.clientLeft || 0 : p.clientTop || 0 : 0)), c.rects.popper[f] - d[f] - k[g])); c.modifiersData[a] = (b = {}, b[h] = f, b) }
},
            effect: function (a) {
                var b = a.state, c = a.options; a = a.name; var d = c.element; d = void 0 === d ? "[data-popper-arrow]" : d; c = c.padding; c = void 0 === c ? 0 : c; if ("string" === typeof d && (d = b.elements.popper.querySelector(d), !d)) return; Na(b.elements.popper, d) && (b.elements.arrow = d, b.modifiersData[a + "#persistent"] = { padding: Pa("number" !== typeof c ? c : Qa(c, fa)) })
            }, requires: ["popperOffsets"], requiresIfExists: ["preventOverflow"]
        }, {
            name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (a) {
                var b = a.state;
                a = a.name; var c = b.rects.reference, d = b.rects.popper, e = b.modifiersData.preventOverflow, f = ea(b, {
                    elementContext: "reference"
                }), h = ea(b, { altBoundary: !0 }); c = Sa(f, c); d = Sa(h, d, e); e = Ta(c); h = Ta(d); b.modifiersData[a] = { referenceClippingOffsets: c, popperEscapeOffsets: d, isReferenceHidden: e, hasPopperEscaped: h }; b.attributes.popper = Object.assign({}, b.attributes.popper, { "data-popper-reference-hidden": e, "data-popper-escaped": h })
            }
        }]
}), U, ha = [], V = [], na = [], $a = [], Eb = Promise.resolve(), Aa = !1, ya = !1, za = new Set, oa = new Set, N, I = function () {
    function a() { }
        var b = a.prototype; b.$destroy = function () { K(this, 1); this.$destroy = z }; b.$on = function (a, b) {
            var c = this.$$.callbacks[a] || (this.$$.callbacks[a] = []); c.push(b); return function () { var a = c.indexOf(b); -1 !== a && c.splice(a, 1) }
        }; b.$set = function () { }; return a
    }(), Hb = function (a) { function b(b) { var c = a.call(this) || this; H(x(c), b, Gb, Fb, G, { config: 6, step: 7 }); return c } C(b, a); return b }(I), Vb = function (a) { function b(b) { var c = a.call(this) || this; H(x(c), b, Jb, Ib, G, { step: 0 }); return c } C(b, a); return b }(I), Pb = function (a) {
        function b(b) {
            var c =
        a.call(this) || this; H(x(c), b, Lb, Kb, G, { cancelIcon: 0, step: 2 });
        return c
    } C(b, a); return b
    }(I), Ob = function (a) { function b(b) { var c = a.call(this) || this; H(x(c), b, Nb, Mb, G, { labelId: 1, element: 0, title: 2 }); return c } C(b, a); return b }(I), Xb = function (a) { function b(b) { var c = a.call(this) || this; H(x(c), b, Rb, Qb, G, { labelId: 0, step: 1 }); return c } C(b, a); return b }(I), Ub = function (a) { function b(b) { var c = a.call(this) || this; H(x(c), b, Tb, Sb, G, { descriptionId: 1, element: 0, step: 2 }); return c } C(b, a); return b }(I), $b = function (a) {
        function b(b) {
            var c =
                    a.call(this) || this; H(x(c), b, Yb, Wb, G, { descriptionId: 0, labelId: 1, step: 2 });
                return c
        } C(b, a);
        return b
        }(I), hc = function (a) { function b(b) { var c = a.call(this) || this; H(x(c), b, bc, Zb, G, { classPrefix: 11, element: 0, descriptionId: 2, firstFocusableElement: 8, focusableElements: 9, labelId: 3, lastFocusableElement: 10, step: 4, dataStepId: 1, getElement: 12 }); return c } C(b, a); Q(b, [{ key: "getElement", get: function () { return this.$$.ctx[12] } }]); return b }(I); (function (a, b) { return b = { exports: {} }, a(b, b.exports), b.exports })(function (a, b) {
            (function () {
                a.exports =
{polyfill:function(){function a(a,b){this.scrollLeft=a;this.scrollTop=b}function b(a){if(null===a||"object"!==typeof a||void 0===a.behavior||"auto"===a.behavior||"instant"===a.behavior)return!0;if("object"===typeof a&&"smooth"===a.behavior)return!1;throw new TypeError("behavior member of ScrollOptions "+a.behavior+" is not a valid value for enumeration ScrollBehavior.");}function e(a,b){if("Y"===b)return a.clientHeight+r<a.scrollHeight;if("X"===b)return a.clientWidth+r<a.scrollWidth}function f(a,
    ...
    var b = e(a, "Y") && f(a, "Y"); a = e(a, "X") && f(a, "X");
    return b || a
} function k(a) { var b = (q() - a.startTime) / 468; var c = .5 * (1 - Math.cos(Math.PI * (1 < b ? 1 : b))); b = a.startX + (a.x - a.startX) * c; c = a.startY + (a.y - a.startY) * c; a.method.call(a.scrollable, b, c); b === a.x && c === a.y || g.requestAnimationFrame(k.bind(g, a)) } function l(b, c, d) {
    var e = q();
    if (b === m.body) {
        var f = g; var h = g.scrollX || g.pageXOffset; b = g.scrollY || g.pageYOffset; var u = n.scroll
        } else f = b, h = b.scrollLeft, b = b.scrollTop, u = a; k({
            scrollable: f, method: u, startTime: e, startX: h, startY: b, x: c, y: d
        })
    } var g = window, m = document;
    if (!("scrollBehavior" in m.documentElement.style && !0 !== g.__forceSmoothScrollPolyfill__)) {
        var p = g.HTMLElement || g.Element, n = { scroll: g.scroll || g.scrollTo, scrollBy: g.scrollBy, elementScroll: p.prototype.scroll || a, scrollIntoView: p.prototype.scrollIntoView }, q = g.performance && g.performance.now ? g.performance.now.bind(g.performance) : Date.now, r = /MSIE |Trident\/|Edge\//.test(g.navigator.userAgent) ?
            1 : 0; g.scroll = g.scrollTo = function (a, c) {
                void 0 !== a && (!0 === b(a) ? n.scroll.call(g, void 0 !== a.left ? a.left : "object" !== typeof a ? a : g.scrollX || g.pageXOffset, void 0 !== a.top ? a.top : void 0 !== c ? c : g.scrollY || g.pageYOffset) : l.call(g, m.body, void 0 !== a.left ? ~~a.left : g.scrollX || g.pageXOffset, void 0 !== a.top ? ~~a.top : g.scrollY || g.pageYOffset))
            }; g.scrollBy = function (a, c) {
                void 0 !== a && (b(a) ? n.scrollBy.call(g, void 0 !== a.left ? a.left : "object" !== typeof a ? a : 0, void 0 !== a.top ? a.top : void 0 !== c ? c : 0) : l.call(g, m.body, ~~a.left + (g.scrollX ||
    g.pageXOffset), ~~a.top + (g.scrollY || g.pageYOffset)))
    }; p.prototype.scroll = p.prototype.scrollTo = function (a, c) {
        if (void 0 !== a)
            if (!0 === b(a)) { if ("number" === typeof a && void 0 === c) throw new SyntaxError("Value could not be converted"); n.elementScroll.call(this, void 0 !== a.left ? ~~a.left : "object" !== typeof a ? ~~a : this.scrollLeft, void 0 !== a.top ? ~~a.top : void 0 !== c ? ~~c : this.scrollTop) } else c = a.left, a = a.top, l.call(this, this, "undefined" === typeof c ? this.scrollLeft : ~~c, "undefined" === typeof a ? this.scrollTop : ~~a)
    }; p.prototype.scrollBy =
            function (a, c) {
                void 0 !== a && (!0 === b(a) ? n.elementScroll.call(this, void 0 !== a.left ? ~~a.left + this.scrollLeft : ~~a + this.scrollLeft, void 0 !== a.top ? ~~a.top + this.scrollTop : ~~c + this.scrollTop) : this.scroll({ left: ~~a.left + this.scrollLeft, top: ~~a.top + this.scrollTop, behavior: a.behavior }))
            }; p.prototype.scrollIntoView = function (a) {
                if (!0 === b(a)) n.scrollIntoView.call(this, void 0 === a ? !0 : a); else {
                    for (a = this; a !== m.body && !1 === h(a);)a = a.parentNode || a.host; var c = a.getBoundingClientRect(), d = this.getBoundingClientRect(); a !==
                                    m.body ? (l.call(this, a, a.scrollLeft + d.left - c.left, a.scrollTop + d.top - c.top), "fixed" !== g.getComputedStyle(a).position && g.scrollBy({
                                        left: c.left, top: c.top, behavior: "smooth"
            ...
            function b(b, c) { void 0 === c && (c = {}); var d = a.call(this, b, c) || this; d.tour = b; d.classPrefix = d.tour.options ? Ua(d.tour.options.classPrefix) : ""; d.styles = b.styles; Da(x(d)); d._setOptions(c); return x(d) || x(d) } C(b, a); var c = b.prototype; c.cancel = function () {
                this.tour.cancel();
    this.trigger("cancel")
}; c.complete = function () {
    this.tour.complete(); this.trigger("complete")
}; c.destroy = function () { this.tooltip && (this.tooltip.destroy(), this.tooltip = null); this.el instanceof HTMLElement && this.el.parentNode && (this.el.parentNode.removeChild(this.el), this.el = null); this.target && this._updateStepTargetOnHide(); this.trigger("destroy") }; c.getTour = function () { return this.tour }; c.hide = function () {
    this.tour.modal.hide(); this.trigger("before-hide"); this.el && (this.el.hidden = !0); this.target && this._updateStepTargetOnHide();
        this.trigger("hide")
    }; c.isOpen = function () {
        return !(!this.el || this.el.hidden)
            }; c.show = function () {
                var a = this;
                if (R(this.options.beforeShowPromise)) {
            ...
            }; c.updateStepOptions = function (a) { Object.assign(this.options, a); this.shepherdElementComponent && this.shepherdElementComponent.$set({ step: this }) }; c._createTooltipContent = function () {
        this.shepherdElementComponent = new hc({
...
descriptionId:this.id+"-description",labelId:this.id+"-label",step:this,styles:this.styles}});return this.shepherdElementComponent.getElement()};c._scrollTo=function(a){var b=Va(this).element;R(this.options.scrollToHandler)?this.options.scrollToHandler(b):b instanceof HTMLElement&&"function"===typeof b.scrollIntoView&&b.scrollIntoView(a)};c._getClassOptions=function(a){var b=this.tour&&this.tour.options&&this.tour.options.defaultStepOptions;b=b&&b.classes?b.classes:"";a=[].concat((a.classes?a.classes:
    "").split(" "), b.split(" ")); a = new Set(a);
        return Array.from(a).join(" ").trim()
    }; c._setOptions = function (a) { var b = this; void 0 === a && (a = {}); this.options = Object.assign({ arrow: !0 }, this.tour && this.tour.options && this.tour.options.defaultStepOptions, a); var c = this.options.when; this.options.classes = this._getClassOptions(a); this.destroy(); this.id = this.options.id || "step-" + wa(); c && Object.keys(c).forEach(function (a) { b.on(a, c[a], b) }) }; c._setupElements = function () {
        void 0 !== this.el && this.destroy(); this.el = this._createTooltipContent();
...
document.body;c.classList.add(this.classPrefix+"shepherd-enabled");c.classList.add(this.classPrefix+"shepherd-target");b.classList.add("shepherd-enabled");this.trigger("show")};c._styleTargetElementForStep=function(a){var b=a.target;b&&(a.options.highlightClass&&b.classList.add(a.options.highlightClass),!1===a.options.canClickTarget&&b.classList.add("shepherd-target-click-disabled"))};c._updateStepTargetOnHide=function(){this.options.highlightClass&&this.target.classList.remove(this.options.highlightClass);
            ...
            function b(b) { var c = a.call(this) || this; H(x(c), b, ec, dc, G, { element: 0, openingProperties: 4, getElement: 5, closeModalOpening: 6, hide: 7, positionModalOpening: 8, setupForStep: 9, show: 10 }); return c } C(b, a); Q(b, [{ key: "getElement", get: function () { return this.$$.ctx[5] } }, { key: "closeModalOpening", get: function () { return this.$$.ctx[6] } }, { key: "hide", get: function () { return this.$$.ctx[7] } }, {
                key: "positionModalOpening",
    get: function () {
        return this.$$.ctx[8]
    }
}, {
    key: "setupForStep", get: function () {
        return this.$$.ctx[9]
    }
    }, { key: "show", get: function () { return this.$$.ctx[10] } }]); return b
    }(I), Y = new Ba, jc = function (a) {
        function b(b) {
            void 0 === b && (b = {}); var c = a.call(this, b) || this; Da(x(c)); c.options = Object.assign({}, { exitOnEsc: !0, keyboardNavigation: !0 }, b); c.classPrefix = Ua(c.options.classPrefix); c.steps = []; c.addSteps(c.options.steps); "active cancel complete inactive show start".split(" ").map(function (a) {
                (function (a) {
                    c.on(a, function (b) {
                        b =
...
this.modal.hide();"cancel"!==a&&"complete"!==a||!this.modal||(a=document.querySelector(".shepherd-modal-overlay-container"))&&a.remove();this.focusedElBeforeOpen instanceof HTMLElement&&this.focusedElBeforeOpen.focus()};c._setupActiveTour=function(){this.trigger("active",{tour:this});Y.activeTour=this};c._skipStep=function(a,b){a=this.steps.indexOf(a);this.show(b?a+1:a-1,b)};c._updateStateBeforeShow=function(){this.currentStep&&this.currentStep.hide();this.isActive()||this._setupActiveTour()};c._setTourID=
                function () { this.id = (this.options.tourName || "tour") + "--" + wa() };
            return b
        }(Ba); Object.assign(Y, { Tour: jc, Step: Ca }); return Y
})
